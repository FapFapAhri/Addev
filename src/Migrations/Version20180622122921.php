 ...
 */
final class Version20180622122921 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(150) NOT NULL, content VARCHAR(30000) NOT NULL, post_date DATETIME DEFAULT NULL, last_modified DATETIME DEFAULT NULL, INDEX IDX_54F1F40BF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, targeting_user_id INT NOT NULL, mark DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(30000) DEFAULT NULL, INDEX IDX_9474526CF675F31B (author_id), INDEX IDX_9474526C50910497 (targeting_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
